...
#include "Galaga_USFX_L01/SpawnFacade.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_L01_API UClass* Z_Construct_UClass_ASpawnFacade_NoRegister();
	GALAGA_USFX_L01_API UClass* Z_Construct_UClass_ASpawnFacade();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnFacade_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASpawnFacade_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_USubscriber_NoRegister, (int32)VTABLE_OFFSET(ASpawnFacade, ISubscriber), false },
		};
	...
	IMPLEMENT_CLASS(ASpawnFacade, 4084729572);
	template<> GALAGA_USFX_L01_API UClass* StaticClass<ASpawnFacade>()
	{
		return ASpawnFacade::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASpawnFacade(Z_Construct_UClass_ASpawnFacade, &ASpawnFacade::StaticClass, TEXT("/Script/Galaga_USFX_L01"), TEXT("ASpawnFacade"), false, nullptr, nullptr, nullptr);
